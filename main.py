...
# Define la función para obtener la densidad de tráfico según la hora
def get_traffic_density(current_time):
    # Define los rangos horarios y la densidad de tráfico asociada
    traffic_hours = [(7, 8), (12, 13), (15, 16), (18, 19), (20, 21)]
    high_density = 200  # Densidad alta de tráfico
    normal_density = 100  # Densidad normal de tráfico

    # Encuentra la hora actual en formato de hora (0-23)
    current_hour = current_time.hour

    # Verifica si la hora actual está dentro de los rangos de tráfico
    for start_hour, end_hour in traffic_hours:
        if start_hour <= current_hour < end_hour:
            return high_density

    # Si no está en un rango de tráfico, usa densidad normal
    return normal_density

# Obtén la hora actual
current_time = datetime.now()

# Define el vehicle_rate según la densidad de tráfico actual
traffic_density = get_traffic_density(current_time)
vehicle_rate = traffic_density  # Puedes ajustar esto según tus necesidades

# Luego, crea la simulación con el vehicle_rate configurado
sim = Simulation()
